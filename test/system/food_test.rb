...
class FoodTest < ApplicationSystemTestCase
  ...
  test "user adds a new food" do # rubocop:disable Metrics/BlockLength
    ...
    within "form.food" do
      ...
      fill_in "Carbohydrates", with: "27.9"
      fill_in "Carbohydrates, sugar part", with: "0.05"
    ...
    assert_nutrition_fact "Carbohydrates", "27.9"
    assert_nutrition_fact "Carbohydrates, sugar part", "0.05"
